								...
								<div class="ProjectIntro_BtnInner">
									<div class="ProjectIntro_PrimaryBtn">
										<button type="button" class="Btn"
											onclick="location.href='RewardsPage.jsp'">프로젝트 밀어주기
										</button>
									</div>
									...
									<div class="Card">
										<div class="StoryCard">
											<div class="StoryContent">
												<h2>
													<img
														src="C:\Users\gch15\Desktop\WebProject\img\ProjectPage_Main.jpg">
												</h2>
												<h2>&nbsp;</h2>
												<h2>
													<strong> 배꼬비 첫 번째 프로젝트 </strong> <br> <strong>
														에그 후라이엔 케찹찹 노트북 파우치 </strong>
												</h2>
											</div>
										</div>
									</div>
