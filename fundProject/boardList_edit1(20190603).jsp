...
<body>
	...
	<div id="container_community">
		...
		<div class="card_board">
			<div class="card_info">
				...
				<div class="card_wirter_profile">
					<img class="cd_profile_img"src="../UserProfile/<%=u_img%>">
					<div class="bd_info">
						<div class="bd_name">
					...
					<!-- 글수정 페이지로 이동 -->
					<a href="../fundProject/ProjectPageBEdit.jsp?b_idx=<%= b_idx %>"> <img
		...
		<!-- view 페이지 -->
			...
			</a> <a href="../fundProject/ProjectPageBView.jsp?b_idx=<%=b_idx%>">
